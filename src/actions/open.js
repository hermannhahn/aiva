export class Open {
    ...
    software(text) {
        ...
        const commandToRun = this.app.gemini.commandLine(
        ...
        this.app.log(commandToRun);
        if (commandToRun === false) {
            this.app.chat.add(
                _('Sorry, I can not open this application right now.'),
            );
            return;
        }
        this.app.utils.executeCommand(commandToRun);
    }
}
