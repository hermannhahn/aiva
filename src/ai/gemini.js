...
${_('Rules for commandline value')}: ${_('Do not use sudo')}, ${_('assume any application is already installed')}, ${_('Always use firefox to open sites, videos, music, and images.')}, ${_('Search create, edit or open documents in Google Drive, Google Docs and Google Sheets website')}, ${_('Use the Google Drive website to search for and open files that I request')}.
